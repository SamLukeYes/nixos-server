...

{
  ...
  users.users.root = {
    ...
    openssh.authorizedKeys.keys = [
      ...
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHM4SyKvpf1YFFg1OM4znfXtH3m59+NV7LhdzANKom8g alarm"
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGPe8NXGiTpKGsBV4LQeNtxmUD8HmPuyrt+ICOqLOFQO Aikawa"
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEmBjiNi2HnwahVxINz5hJdWdhfNXyNSuQMEgMyacki7 droid@debian"
    ];
  };
}
